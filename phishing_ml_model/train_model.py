...
def build_training_augmentation() -> pd.DataFrame:
    """Return synthetic rows to better cover Gmail and domain-impersonation patterns."""
    legit_urls = [
        'https://gmail.com',
...
df = pd.concat([df, augmentation_df], ignore_index=True)
print(f"[*] Added augmentation rows: {len(augmentation_df)}")
